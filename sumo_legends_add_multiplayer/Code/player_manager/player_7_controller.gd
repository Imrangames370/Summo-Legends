...
var controller_number = 6 #leave at -1 for non controller scripts. manually set. used only for controller connections with player_1_controller to player_8 controller
